...
// The hiring funnel — moved verbatim out of CaregiversPage when M18b split that
// page into Pipeline | Roster tabs. Nothing here changed but the wrapper: the
// PageHeader and its "New applicant" action now live on the page shell, which
// hands the create-dialog state down so the button stays in the header.
const PAGE_SIZE = 50;
