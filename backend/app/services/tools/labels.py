...
TOOL_LABELS: dict[str, str] = {
    ...
    "find_available_caregivers": "Finding available caregivers",
    "record_call_out": "Recording a call-out",
    "assign_caregiver": "Assigning a caregiver",
    "record_visit_check_in": "Recording a visit check-in",
    "record_visit_check_out": "Recording a visit check-out",
