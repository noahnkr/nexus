...
insert into public.leads (id, tenant_id, name, phone, email, source, status, region_id, requirements) values
  ...
  ('33333333-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Doris Nakamura',   '+16195550103', 'doris.n@example.com',     'phone',     'visit_scheduled', '11111111-0000-0000-0000-000000000003', '{"hours_per_week": 30, "needed_qualifications": ["Dementia Care","Medication Management"]}'),
